#!/usr/bin/env python3
"""
Final EFI Boot Fix v0.00.31 for INSTYAML
    ...
    with tempfile.TemporaryDirectory(prefix="instyaml_efi_fix_") as temp_dir:
        ...
        try:
            ...
            subprocess.run([
                ...
                "https://raw.githubusercontent.com/MachoDrone/instyaml/main/autoinstall.yaml"
            ], check=True)
            ...
            print("3. Both should boot to Ubuntu installer")
